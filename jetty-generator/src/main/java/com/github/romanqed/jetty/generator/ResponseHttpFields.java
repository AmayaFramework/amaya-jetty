...
public class ResponseHttpFields extends HttpFields.Mutable.Wrapper {
    ...
    public Mutable getMutableHttpFields() {
        return getWrapped();
    }

    public boolean commit() {
        var committed = _committed.compareAndSet(false, true);
    ...
    public Mutable clear() {
        ...
        for (var iterator = getMutableHttpFields().listIterator(size()); iterator.hasPrevious(); ) {
            var field = iterator.previous();
